 ...
 * @property {ICubeMeta} data - The cube meta data as an @see {@link IMatrixMetadata} object.
 */
export interface ICubeMetaResult {
    isLoading: boolean;
    isError: boolean;
    data: IMatrixMetadata;
}

const fetchCubeMeta = async(idStack: string[]): Promise<IMatrixMetadata> => {
