...
import { IMenuProps, SelectableDimensionMenus, ISelectionState , getSelections } from './SelectableDimensionMenus';
import '@testing-library/jest-dom';
import { IQueryVisualizationResponse, EVariableType } from '@statisticsfinland/pxvisualizer';
