...
interface ITopNVariableSelectionProps {
...
export const TopNVariableSelection: React.FC<ITopNVariableSelectionProps> = ({ numberOfItems, onNumberChanged }) => {
...
export default TopNVariableSelection;