...
namespace Visualization
{
    internal static class VariableOrderingTests
    {
        ...
        private readonly static IReadOnlyList<double?> expectedData = new List<double?> {
        ...
        public static void BuildVisualizationResponseTest_TableOrdering_1_Selectable_ExplicitLayout_For_All()
        {
            ...
            Assert.AreEqual(new[] { "variable-2", "variable-0", "variable-1", "variable-3" }, result.MetaData.Select(v => v.Code));
        ...
        public static void BuildVisualizationResponseTest_TableOrdering_2_Selectables_ExplicitLayout_For_All()
        {
            ...
            TableVisualizationSettings testSettings = new(
                new Layout(
                    new[] { "variable-1", "variable-0", "variable-4" },
                    new[] { "variable-2", "variable-3" }
                ));
            ...
            Assert.AreEqual(new[] { "variable-2", "variable-4", "variable-1", "variable-0", "variable-3" }, result.MetaData.Select(v => v.Code));
